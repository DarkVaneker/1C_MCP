...
// Функция преобразует значение в его строковое представление для вставки в код.
//
// Параметры:
...
//
Функция ПредставлениеЗначенияДляКода(Значение) Экспорт
	...
	ИначеЕсли ТипЗнч(Значение) = Тип("Дата") Тогда
		...
		Возврат "Дата(" + Формат(Значение, "ДФ=yyyy,MM,dd,HH,mm,ss") + ")";
	...
	Иначе
		...
		// Типы Массив и Структура пока не поддерживаются для упрощения.
		// При необходимости их поддержка может быть добавлена.
		ВызватьИсключение "Неподдерживаемый тип параметра: " + ТипЗнч(Значение);
